...
jQuery(document).ready(function($) {
	...
	(function() {
		...
		var $form   = $('.contact-form'),
			$loader = '<img src="../wp-content/themes/mrp/img/loader.gif" height="11" width="16" alt="Loading..." />';
		...
		$form.on('click', 'input[type=submit]', function(e){
			...
			// Make AJAX request
			$.post('../wp-content/themes/mrp/php/contact-send.php', $form.serialize(), function( data ) {
